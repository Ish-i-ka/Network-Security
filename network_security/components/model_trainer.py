...
import dagshub
#dagshub.init(repo_owner='Ish-i-ka', repo_name='Network-Security', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric, best_model_name):
        ...
        with mlflow.start_run():
            ...
            print(f"F1 Score Type: {type(classificationmetric.f1_score)}") 
            print(f"Precision Score Type: {type(classificationmetric.precision_score)}") 
            print(f"Recall Score Type: {type(classificationmetric.recall_score)}") 
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        ...
        self.track_mlflow(best_model, classification_train_metric, best_model_name=best_model_name)
        
        y_test_pred = best_model.predict(x_test)
        classification_test_metric = get_classification_score(y_true=y_test, y_pred=y_test_pred)
       
        self.track_mlflow(best_model, classification_test_metric, best_model_name=best_model_name)
