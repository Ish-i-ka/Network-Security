...
from network_security.utils.main_utils.utils import save_object,load_numpy_array_data,load_object,evaluate_models
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        #Function to track experiments with mlflow
